...
public class ConnectionWrapper {
	 ...
	 * @see java.sql.Connection
	 */
	public CallableStatementWrapper prepareCall(String sql, int resultSetType,
	...
	public CallableStatementWrapper prepareCall(String sql, int resultSetType,
			int resultSetConcurrency, int resultSetHoldability) {
		try {
			return new CallableStatementWrapper(connection.prepareCall(sql, resultSetType, resultSetConcurrency, resultSetHoldability), this);
		} catch (SQLException e) {
			throw new JdbcException(e);
		}
	}
	 ...
	 * @see java.sql.Connection
	 */
	public PreparedStatementWrapper prepareStatement(String sql, int resultSetType,
			int resultSetConcurrency) {
		try {
