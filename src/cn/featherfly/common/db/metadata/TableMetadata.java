...
public class TableMetadata {
	...
	private List<ColumnMetadata> primaryColumns = new ArrayList<ColumnMetadata>(1);

	private Map<String, ColumnMetadata> columnMap = new HashMap<String, ColumnMetadata>(0);
